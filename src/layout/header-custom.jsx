        ...
        return (
            <Header style={{ background: '#fff', padding: 0, height: 65 }} className="custom-theme" >
                ...
                >
                    ...
                    <SubMenu title={<span className="avatar"><img src={'https://ss1.bdstatic.com/70cFvXSh_Q1YnxGkpoWK1HF6hhy/it/u=3445991745,3352873376&fm=27&gp=0.jpg'} alt="头像" /><i className="on bottom b-white" /></span>}>
